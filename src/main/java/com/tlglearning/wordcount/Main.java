 ...
 * This demonstration uses (int eh included methods) implementations of the {@link java.util.Map},
...
private Main(){
   ...
   * <p>This method assumes that a text file name {@code hound-of-the-baskervilles.txt} is located
   * ont he classpath; otherwise (or if that file cannot be read for some reason), an instance of
